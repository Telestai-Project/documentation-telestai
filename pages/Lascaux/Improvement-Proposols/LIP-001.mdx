...
4. **Rebrand Lascaux to Lasko** as part of the v4.0.0 release.
...
- The system will operate similarly to `lascaux-nodes`, where authors **submit a PR request** to add their address as our early POC with plans to elaborate on this system later on for broader community accessibility and support.
...
2. Create **Verified Author web portal** for onboarding creators.
