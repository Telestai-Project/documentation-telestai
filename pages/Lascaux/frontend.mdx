...
1. **Node Connection & Status Monitoring**:
   - Users can connect to a **node** by entering its URL.
...
3. **Voting System**:
   ...
   - If a post’s votes drop to **-100 or below**, it is automatically removed.
...
1. **Connecting to a Node**:
   - Enter the node URL and click **“Connect to Node”**.
