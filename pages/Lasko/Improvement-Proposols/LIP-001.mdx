...
1. **Create Post Error Handling** by reading the response body only once as text, attempt to parse it as JSON, and fall back to raw text if parsing fails, thus preventing the error of the body being consumed twice. ✅
