...
- **Simplified User Experience**: Zeroa v2 will make it effortless to authenticate with platforms like **Lasko** and, eventually, **Mercatus**.
...
### **3. Lasko: Challenges in Decentralized Governance**
Lasko has been an incredible learning experience, giving us valuable insight into the challenges of balancing decentralization with moderation. As a decentralized social media platform, it must:
...
At this stage, development was intentionally paused (Resumed in February 2025) while we rethought how Lasko and our other platforms, such as Zeroa, can evolve. The prototypes from 2024 have been instrumental in understanding data schemas, governance mechanisms, and potential content policies. This helped us form the scope and direction for the next iterations of the platform, ensuring it’s both scalable and impactful.
...
- Comprehensive access to Telestai tools, such as Lasko and the web wallet.
...
- Serve as a launchpad for Telestai applications such as **Lasko**, **Mercatus**, and others.
...
3. **Telestai Dashboard**:
   ...
   - Ensure compatibility with Lasko, Mercatus, and other ecosystem tools.
...
4. **Lasko Development**:
   ...
   - Identify key features for Lasko v4 and begin development in Q1/Q2 2025.
...
- Prepare for **mobile accessibility** with Zeroa and Lasko, broadening the ecosystem’s reach.
- Develop a revenue-sharing model for creators on Lasko, incentivizing meaningful contributions.
